        ...
        {analysisResult ? (
          <div>
            {/* <ReactMarkdown
              ...
              children={analysisResult}
              components={{
                h1: ({ node, ...props }) => <h1 {...props} className="text-red-500 text-2xl font-bold mb-4" />,
                h2: ({ node, ...props }) => <h2 {...props} className="text-blue-500 text-xl font-semibold mb-3" />,
                h3: ({ node, ...props }) => <h3 {...props} className="text-green-500 text-lg font-medium mb-2" />,
                p: ({ node, ...props }) => <p {...props} className="text-gray-700 mb-2" />,
                li: ({ node, ...props }) => <li {...props} className="text-gray-600 list-disc ml-6 mb-1" />,
              }}
            /> */}
